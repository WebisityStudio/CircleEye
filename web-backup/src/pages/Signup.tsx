...
import { signUpWithEmail, signInWithGoogle } from '../supabase/authService';
        ...
        <div className="w-full max-w-md">
          ...
          <div className="card">
            <div className="text-center mb-8">
              ...
              <p className="text-brand-textGrey">Join Circle Overwatch today</p>
            </div>
            ...
            <form
              onSubmit={async (e) => {
                ...
                setErr(null);
                try {
                  const { error } = await signUpWithEmail(emailValue, passwordValue);
